...
(function () {
    ...
    //fukuball 20111005
    Canvas.Element.prototype.moveToLast = function(allOnTop) {
        var temp = this._aImages[0];
        this._aImages[0] = this._aImages[this._aImages.length-1];
        this._aImages[this._aImages.length-1] = temp;
        var containerCanvas = (allOnTop) ? this._oContextTop : this._oContextContainer;
