...
if(!empty($_COOKIE['user_id'])){ 
    ...
    $dbc = connectdb();
    $query_paid_exchange = "SELECT id FROM exchange_record WHERE buyer_id='$user_obj->id' AND status='paid' ORDER BY order_time DESC";
                ...
                <div id="item_sub" style="border-bottom: none;">
                    ...
                    <div class="left" id="price">
                        ...
                        <div class="func_block">
                            <a onclick="exchange_comment_box('&exchange_id=<?=$exchange_obj->id?>&type=buyer')"><span>評價</span></a>
                        </div>
                    </div>
